...
//-----------------------------------------------------------------------------------------------------------------------
    for (int npc_count =MAX_NPCS-1;npc_count >=0;npc_count--)  // npcs
    {
        for (int bullet_count = MAX_BULLETS-1;bullet_count >=0;bullet_count--)  // npcs bullets
        {
            if (game_o.npc[npc_count].bullet[bullet_count].active)
            {
                ...
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_000.ref_number) texture.projectile_000.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_001.ref_number) texture.projectile_001.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_002.ref_number) texture.projectile_002.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_003.ref_number) texture.projectile_003.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_004.ref_number) texture.projectile_004.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_005.ref_number) texture.projectile_005.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_006.ref_number) texture.projectile_006.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_007.ref_number) texture.projectile_007.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_008.ref_number) texture.projectile_008.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_009.ref_number) texture.projectile_009.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                ...
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_011.ref_number) texture.projectile_011.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_012.ref_number) texture.projectile_012.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_013.ref_number) texture.projectile_013.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_014.ref_number) texture.projectile_014.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_015.ref_number) texture.projectile_015.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_016.ref_number) texture.projectile_016.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_017.ref_number) texture.projectile_017.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_018.ref_number) texture.projectile_018.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_019.ref_number) texture.projectile_019.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                ...
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_021.ref_number) texture.projectile_021.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_022.ref_number) texture.projectile_022.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_023.ref_number) texture.projectile_023.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_024.ref_number) texture.projectile_024.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_025.ref_number) texture.projectile_025.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_026.ref_number) texture.projectile_026.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_027.ref_number) texture.projectile_027.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_028.ref_number) texture.projectile_028.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
                if (game_o.projectile[game_o.npc[npc_count].bullet[bullet_count].warhead].image == texture.projectile_029.ref_number) texture.projectile_029.draw(game_o.npc[npc_count].bullet[bullet_count].x_pos,game_o.npc[npc_count].bullet[bullet_count].y_pos,z_pos,game_o.npc[npc_count].bullet[bullet_count].width,game_o.npc[npc_count].bullet[bullet_count].height,180.0f);
        ...
        if (game_o.npc[npc_count].active)
        {
            ...
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_000.ref_number) texture.ship_000.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_001.ref_number) texture.ship_001.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_002.ref_number) texture.ship_002.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_003.ref_number) texture.ship_003.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_004.ref_number) texture.ship_004.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_005.ref_number) texture.ship_005.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_006.ref_number) texture.ship_006.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_007.ref_number) texture.ship_007.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_008.ref_number) texture.ship_008.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_009.ref_number) texture.ship_009.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_010.ref_number) texture.ship_010.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_011.ref_number) texture.ship_011.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_012.ref_number) texture.ship_012.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_013.ref_number) texture.ship_013.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_014.ref_number) texture.ship_014.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_015.ref_number) texture.ship_015.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_016.ref_number) texture.ship_016.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_017.ref_number) texture.ship_017.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_018.ref_number) texture.ship_018.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_019.ref_number) texture.ship_019.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_020.ref_number) texture.ship_020.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_021.ref_number) texture.ship_021.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_022.ref_number) texture.ship_022.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_023.ref_number) texture.ship_023.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_024.ref_number) texture.ship_024.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
            if (game_o.enemy[game_o.npc[npc_count].type_npc].image == texture.ship_025.ref_number) texture.ship_025.draw(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,z_pos,game_o.npc[npc_count].height,game_o.npc[npc_count].width, 90.0f,temp_r,temp_g,temp_b,temp_a);
        }
    }
    for (int count =0;count < MAX_BULLETS;count++) //player bullets
    {
        if (game_o.player.bullet[count].active)
        {
            ...
            if (game_o.player.bullet[count].warhead ==  0) texture.projectile_000.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead ==  1) texture.projectile_001.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead ==  2) texture.projectile_002.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead ==  3) texture.projectile_003.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead ==  4) texture.projectile_004.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead ==  5) texture.projectile_005.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead ==  6) texture.projectile_006.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead ==  7) texture.projectile_007.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead ==  8) texture.projectile_008.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead ==  9) texture.projectile_009.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 10) texture.projectile_010.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 11) texture.projectile_011.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 12) texture.projectile_012.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 13) texture.projectile_013.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 14) texture.projectile_014.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 15) texture.projectile_015.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 16) texture.projectile_016.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 17) texture.projectile_017.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 18) texture.projectile_018.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 19) texture.projectile_019.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 20) texture.projectile_020.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 21) texture.projectile_021.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 22) texture.projectile_022.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 23) texture.projectile_023.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 24) texture.projectile_024.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 25) texture.projectile_025.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 26) texture.projectile_026.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 27) texture.projectile_027.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 28) texture.projectile_028.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 29) texture.projectile_029.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 30) texture.projectile_030.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 31) texture.projectile_031.draw(game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
        }
    }
   ...
   for (int count = MAX_WEXPS;count >=1;count--)  // wexp
   {
    ...
    if (game_o.number_bombs > 2) texture.bomb_powerup.draw(-0.810f, 0.9375f, 0.001f, 0.075f, 0.075f); // bomb icons
    if (game_o.number_bombs > 3) texture.bomb_powerup.draw(-0.735f, 0.9375f, 0.001f, 0.075f, 0.075f); // bomb icons
    if (game_o.number_bombs > 4) texture.bomb_powerup.draw(-0.660f, 0.9375f, 0.001f, 0.075f, 0.075f); // bomb icons
    if (game_o.number_bombs > 5) texture.bomb_powerup.draw(-0.585f, 0.9375f, 0.001f, 0.075f, 0.075f); // bomb icons

    if (game_o.player.front_weapon > -1)
    {
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_000.ref_number) texture.projectile_000.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_001.ref_number) texture.projectile_001.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_002.ref_number) texture.projectile_002.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_003.ref_number) texture.projectile_003.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_004.ref_number) texture.projectile_004.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_005.ref_number) texture.projectile_005.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_006.ref_number) texture.projectile_006.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_007.ref_number) texture.projectile_007.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_008.ref_number) texture.projectile_008.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_009.ref_number) texture.projectile_009.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_010.ref_number) texture.projectile_010.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_011.ref_number) texture.projectile_011.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_012.ref_number) texture.projectile_012.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_013.ref_number) texture.projectile_013.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_014.ref_number) texture.projectile_014.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_015.ref_number) texture.projectile_015.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_016.ref_number) texture.projectile_016.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_017.ref_number) texture.projectile_017.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_018.ref_number) texture.projectile_018.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_019.ref_number) texture.projectile_019.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_020.ref_number) texture.projectile_020.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_021.ref_number) texture.projectile_021.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_022.ref_number) texture.projectile_022.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_023.ref_number) texture.projectile_023.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_024.ref_number) texture.projectile_024.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_025.ref_number) texture.projectile_025.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_026.ref_number) texture.projectile_026.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_027.ref_number) texture.projectile_027.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_028.ref_number) texture.projectile_028.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_029.ref_number) texture.projectile_029.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_030.ref_number) texture.projectile_030.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.front_weapon].image == texture.projectile_031.ref_number) texture.projectile_031.draw(-0.3475f, 0.9375f, 0.001f, 0.075f, 0.075f); // front weapon picture next to the exp bar
    ...
    if (game_o.player.side_weapon > -1)
    {
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_000.ref_number) texture.projectile_000.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_001.ref_number) texture.projectile_001.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_002.ref_number) texture.projectile_002.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_003.ref_number) texture.projectile_003.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_004.ref_number) texture.projectile_004.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_005.ref_number) texture.projectile_005.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_006.ref_number) texture.projectile_006.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_007.ref_number) texture.projectile_007.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_008.ref_number) texture.projectile_008.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_009.ref_number) texture.projectile_009.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_010.ref_number) texture.projectile_010.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_011.ref_number) texture.projectile_011.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_012.ref_number) texture.projectile_012.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_013.ref_number) texture.projectile_013.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_014.ref_number) texture.projectile_014.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_015.ref_number) texture.projectile_015.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_016.ref_number) texture.projectile_016.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_017.ref_number) texture.projectile_017.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_018.ref_number) texture.projectile_018.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_019.ref_number) texture.projectile_019.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_020.ref_number) texture.projectile_020.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_021.ref_number) texture.projectile_021.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_022.ref_number) texture.projectile_022.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_023.ref_number) texture.projectile_023.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_024.ref_number) texture.projectile_024.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_025.ref_number) texture.projectile_025.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_026.ref_number) texture.projectile_026.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_027.ref_number) texture.projectile_027.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_028.ref_number) texture.projectile_028.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_029.ref_number) texture.projectile_029.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_030.ref_number) texture.projectile_030.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        if(game_o.projectile[game_o.player.side_weapon].image == texture.projectile_031.ref_number) texture.projectile_031.draw(-0.0475f, 0.9375f, 0.001f, 0.075f, 0.075f); // side weapon picture next to the exp bar
        ...
        texture.weapon_bar.draw (0.0f +(temp_val/2),0.9375f, 0.001f,temp_val, 0.075f);// side weapon exp bar
    }

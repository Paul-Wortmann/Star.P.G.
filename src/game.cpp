...
//-----------------------------------------------------------------------------------------------------------------------
    ...
    for (int count =0;count < MAX_BULLETS;count++) //player bullets
    {
        if (game_o.player.bullet[count].active)
        {
            ...
            if (game_o.player.bullet[count].warhead == 32) texture.projectile_032.draw(true,game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 33) texture.projectile_033.draw(true,game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
            if (game_o.player.bullet[count].warhead == 34) texture.projectile_034.draw(true,game_o.player.bullet[count].x_pos,game_o.player.bullet[count].y_pos,z_pos,game_o.player.bullet[count].width,game_o.player.bullet[count].height);
        }
    }
    for (int supportship_count = 0;supportship_count < MAX_SUPPORTSHIPS;supportship_count++)//display support ship bullets
    {
        for (int bullet_count = 0;bullet_count < MAX_BULLETS;bullet_count++)
        {
            if (game_o.supportship[supportship_count].bullet[bullet_count].active)
            {
                ...
                if (game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].image == texture.projectile_032.ref_number) texture.projectile_032.draw(true,game_o.supportship[supportship_count].bullet[bullet_count].x_pos,game_o.supportship[supportship_count].bullet[bullet_count].y_pos,z_pos,game_o.supportship[supportship_count].bullet[bullet_count].width,game_o.supportship[supportship_count].bullet[bullet_count].height);
                if (game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].image == texture.projectile_033.ref_number) texture.projectile_033.draw(true,game_o.supportship[supportship_count].bullet[bullet_count].x_pos,game_o.supportship[supportship_count].bullet[bullet_count].y_pos,z_pos,game_o.supportship[supportship_count].bullet[bullet_count].width,game_o.supportship[supportship_count].bullet[bullet_count].height);
                if (game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].image == texture.projectile_034.ref_number) texture.projectile_034.draw(true,game_o.supportship[supportship_count].bullet[bullet_count].x_pos,game_o.supportship[supportship_count].bullet[bullet_count].y_pos,z_pos,game_o.supportship[supportship_count].bullet[bullet_count].width,game_o.supportship[supportship_count].bullet[bullet_count].height);
            }
        }
    }

...
int init_game(bool re_init)
{
   ...
   game_o.shield[0].name             = L"Terbium Shields";
...
int initialize_supportships(void)
{
   ...
   {
      game_o.supportship[supportship_count].rate_of_fire       = 5;
      game_o.supportship[supportship_count].rate_of_fire_count = 0;
      game_o.supportship[supportship_count].active             = false;
      game_o.supportship[supportship_count].level              = -1;
      game_o.supportship[supportship_count].image              = supportship_count+242;
      game_o.supportship[supportship_count].width              = 0.075f;
      game_o.supportship[supportship_count].height             = 0.075f;
      for (int bullet_count = 0;bullet_count < MAX_BULLETS-1;bullet_count++)
      {
         game_o.supportship[supportship_count].bullet[bullet_count].active = false;
         game_o.supportship[supportship_count].bullet[bullet_count].x_pos  = 2.0f;
         game_o.supportship[supportship_count].bullet[bullet_count].y_pos  = 2.0f;
         if (supportship_count == 0) game_o.supportship[supportship_count].bullet[bullet_count].warhead = 31;
         if (supportship_count == 1) game_o.supportship[supportship_count].bullet[bullet_count].warhead = 32;
         if (supportship_count == 2) game_o.supportship[supportship_count].bullet[bullet_count].warhead = 33;
         if (supportship_count == 3) game_o.supportship[supportship_count].bullet[bullet_count].warhead = 34;
      }
   }
   return(1);
};
...
int spawn_supportship_bullet(int supportship_count,int location, int direction_x, int direction_y)
{
   ...
   {
       if ((!game_o.supportship[supportship_count].bullet[bullet_count].active) && (!done))
       {
          done = true;
          game_o.supportship[supportship_count].bullet[bullet_count].active = true;
          game_o.supportship[supportship_count].bullet[bullet_count].x_pos  = game_o.player.x_pos-(game_o.player.width/4)+game_o.supportship[supportship_count].width;
          if (location  == 0) game_o.supportship[supportship_count].bullet[bullet_count].y_pos  = game_o.player.y_pos-(game_o.player.hight/2)-game_o.supportship[supportship_count].height;
          if (location  == 1) game_o.supportship[supportship_count].bullet[bullet_count].y_pos  = game_o.player.y_pos+(game_o.player.hight/2)+game_o.supportship[supportship_count].height;
          if (location  == 2) game_o.supportship[supportship_count].bullet[bullet_count].y_pos  = game_o.player.y_pos-(game_o.player.hight/2)-((game_o.supportship[supportship_count].height/2)*3);
          if (location  == 3) game_o.supportship[supportship_count].bullet[bullet_count].y_pos  = game_o.player.y_pos+(game_o.player.hight/2)+((game_o.supportship[supportship_count].height/2)*3);
          if (location  == 4) game_o.supportship[supportship_count].bullet[bullet_count].y_pos  = game_o.player.y_pos-(game_o.player.hight/2)-game_o.supportship[supportship_count].height;
          if (location  == 5) game_o.supportship[supportship_count].bullet[bullet_count].y_pos  = game_o.player.y_pos+(game_o.player.hight/2)+game_o.supportship[supportship_count].height;
          if (location  == 4) game_o.supportship[supportship_count].bullet[bullet_count].x_pos -= game_o.supportship[supportship_count].width/2;
          if (location  == 5) game_o.supportship[supportship_count].bullet[bullet_count].x_pos -= game_o.supportship[supportship_count].width/2;
          game_o.supportship[supportship_count].bullet[bullet_count].x_dir   = direction_x;
          game_o.supportship[supportship_count].bullet[bullet_count].y_dir   = direction_y;
          game_o.supportship[supportship_count].bullet[bullet_count].x_speed = game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].speed;
          game_o.supportship[supportship_count].bullet[bullet_count].y_speed = game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].speed;
          game_o.supportship[supportship_count].bullet[bullet_count].hight   = game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].size;
          game_o.supportship[supportship_count].bullet[bullet_count].width   = game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].size;
       }
   }
   if (done) return(1);
   else return(0);
...
int process_supportships(bool spawn_bullet)
{
   ...
   for (int supportship_count = 0;supportship_count < MAX_SUPPORTSHIPS-1;supportship_count++)
   {
      ...
      {
               if (game_o.supportship[supportship_count].rate_of_fire_count > game_o.supportship[supportship_count].rate_of_fire)//rof spawn bullets
               {
                  game_o.supportship[supportship_count].rate_of_fire_count = 0;
                  if ((game_o.supportship[supportship_count].level >= 0) && (spawn_bullet))
                  {
                     spawn_supportship_bullet(supportship_count,0,0,0);
                     spawn_supportship_bullet(supportship_count,1,1,1);
                  }
                  if ((game_o.supportship[supportship_count].level >= 1) && (spawn_bullet))
                  {
                     spawn_supportship_bullet(supportship_count,0,2,2);
                     spawn_supportship_bullet(supportship_count,1,3,3);
                     spawn_supportship_bullet(supportship_count,2,2,2);
                     spawn_supportship_bullet(supportship_count,3,3,3);
                  }
                  if ((game_o.supportship[supportship_count].level >= 2) && (spawn_bullet))
                  {
                     spawn_supportship_bullet(supportship_count,0,4,4);
                     spawn_supportship_bullet(supportship_count,1,5,5);
                     spawn_supportship_bullet(supportship_count,2,4,4);
                     spawn_supportship_bullet(supportship_count,3,5,5);
                     spawn_supportship_bullet(supportship_count,4,4,4);
                     spawn_supportship_bullet(supportship_count,5,5,5);
                  }
               }
               else game_o.supportship[supportship_count].rate_of_fire_count++;

         for (int bullet_count = 0;bullet_count < MAX_BULLETS-1;bullet_count++)//process bullets
         {
            if (game_o.supportship[supportship_count].bullet[bullet_count].active)
            {
                switch (game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].movement)
                {
                  //case 0:
                  //break;
                  case 1:
               ...
               if (game_o.active_npc_count > 0)
               {
                  ...
                  if (x_temp_velocity < y_temp_velocity)
                  {
                     x_temp_velocity = ((x_temp_velocity/y_temp_velocity) * game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].speed) + game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].speed;
                     y_temp_velocity = game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].speed;
                  }
                  else
                  {
                     y_temp_velocity = ((x_temp_velocity/y_temp_velocity) * game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].speed) + game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].speed;
                     x_temp_velocity = game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].speed;
                  }
                  if (game_o.supportship[supportship_count].bullet[bullet_count].x_pos < game_o.npc[target_id].x_pos)
                  {
                      game_o.supportship[supportship_count].bullet[bullet_count].x_pos += x_temp_velocity;
                      if (game_o.supportship[supportship_count].bullet[bullet_count].y_pos < game_o.npc[target_id].y_pos) game_o.supportship[supportship_count].bullet[bullet_count].y_pos += y_temp_velocity;
                      if (game_o.supportship[supportship_count].bullet[bullet_count].y_pos > game_o.npc[target_id].y_pos) game_o.supportship[supportship_count].bullet[bullet_count].y_pos -= y_temp_velocity;
                  }
                  else game_o.supportship[supportship_count].bullet[bullet_count].x_pos += x_temp_velocity;
               }
               else
               {
                  game_o.supportship[supportship_count].bullet[bullet_count].x_pos += game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].speed;
                  if (game_o.supportship[supportship_count].bullet[bullet_count].y_pos < game_o.player.y_pos) game_o.supportship[supportship_count].bullet[bullet_count].y_pos -= game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].speed;
                  if (game_o.supportship[supportship_count].bullet[bullet_count].y_pos > game_o.player.y_pos) game_o.supportship[supportship_count].bullet[bullet_count].y_pos += game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].speed;
               }
                        if (game_o.supportship[supportship_count].bullet[bullet_count].x_pos > (1.0f+game_o.supportship[supportship_count].bullet[bullet_count].width/2))
                        {
                            game_o.supportship[supportship_count].bullet[bullet_count].active = false;
                            game_o.supportship[supportship_count].bullet[bullet_count].x_pos  = 2.0f;
                            game_o.supportship[supportship_count].bullet[bullet_count].y_pos  = 2.0f;
                        ...
                        if (game_o.supportship[supportship_count].bullet[bullet_count].y_pos > (1.0f+game_o.supportship[supportship_count].bullet[bullet_count].hight/2))
                        {
                            game_o.supportship[supportship_count].bullet[bullet_count].active = false;
                            game_o.supportship[supportship_count].bullet[bullet_count].x_pos  = 2.0f;
                            game_o.supportship[supportship_count].bullet[bullet_count].y_pos  = 2.0f;
                        ...
                        break;
                        default:
                     if (game_o.supportship[supportship_count].bullet[bullet_count].x_dir == 0)
                     {
                        game_o.supportship[supportship_count].bullet[bullet_count].x_pos += game_o.supportship[supportship_count].bullet[bullet_count].x_speed;
                        if (game_o.supportship[supportship_count].bullet[bullet_count].x_pos > (1.0f+game_o.supportship[supportship_count].bullet[bullet_count].width/2))
                        {
                            game_o.supportship[supportship_count].bullet[bullet_count].active = false;
                            game_o.supportship[supportship_count].bullet[bullet_count].x_pos  = 2.0f;
                     ...
                     if (game_o.supportship[supportship_count].bullet[bullet_count].x_dir == 2)
                     {
                        game_o.supportship[supportship_count].bullet[bullet_count].x_pos += (game_o.supportship[supportship_count].bullet[bullet_count].x_speed);
                        if (game_o.supportship[supportship_count].bullet[bullet_count].x_pos > (1.0f+game_o.supportship[supportship_count].bullet[bullet_count].width/2))
                        {
                     ...
                     if (game_o.supportship[supportship_count].bullet[bullet_count].x_dir == 4)
                     {
                        game_o.supportship[supportship_count].bullet[bullet_count].x_pos += (game_o.supportship[supportship_count].bullet[bullet_count].x_speed);
                        if (game_o.supportship[supportship_count].bullet[bullet_count].x_pos > (1.0f+game_o.supportship[supportship_count].bullet[bullet_count].width/2))
                        {
                     ...
                     if (game_o.supportship[supportship_count].bullet[bullet_count].x_dir == 1)
                     {
                        game_o.supportship[supportship_count].bullet[bullet_count].x_pos += game_o.supportship[supportship_count].bullet[bullet_count].x_speed;
                       if (game_o.supportship[supportship_count].bullet[bullet_count].x_pos > (1.0f+game_o.supportship[supportship_count].bullet[bullet_count].width/2))
                        {
                     ...
                     if (game_o.supportship[supportship_count].bullet[bullet_count].x_dir == 3)
                     {
                        game_o.supportship[supportship_count].bullet[bullet_count].x_pos += game_o.supportship[supportship_count].bullet[bullet_count].x_speed;
                        if (game_o.supportship[supportship_count].bullet[bullet_count].x_pos > (1.0f+game_o.supportship[supportship_count].bullet[bullet_count].width/2))
                        {
                     ...
                     if (game_o.supportship[supportship_count].bullet[bullet_count].x_dir == 5)
                     {
                        game_o.supportship[supportship_count].bullet[bullet_count].x_pos += game_o.supportship[supportship_count].bullet[bullet_count].x_speed;
                        if (game_o.supportship[supportship_count].bullet[bullet_count].x_pos > (1.0f+game_o.supportship[supportship_count].bullet[bullet_count].width/2))
                        {
                     ...
                     if (game_o.supportship[supportship_count].bullet[bullet_count].y_dir == 0)
                     {
                        game_o.supportship[supportship_count].bullet[bullet_count].y_pos -= game_o.supportship[supportship_count].bullet[bullet_count].y_speed*0.25;
                        if (game_o.supportship[supportship_count].bullet[bullet_count].y_pos < (-1.0f-game_o.supportship[supportship_count].bullet[bullet_count].hight/2))
                        {
                            game_o.supportship[supportship_count].bullet[bullet_count].active = false;
                            game_o.supportship[supportship_count].bullet[bullet_count].x_pos  = 2.0f;
                     ...
                     if (game_o.supportship[supportship_count].bullet[bullet_count].y_dir == 2)
                     {
                        game_o.supportship[supportship_count].bullet[bullet_count].y_pos -= game_o.supportship[supportship_count].bullet[bullet_count].y_speed*0.75f;
                        if (game_o.supportship[supportship_count].bullet[bullet_count].y_pos < (-1.0f-game_o.supportship[supportship_count].bullet[bullet_count].hight/2))
                        {
                            game_o.supportship[supportship_count].bullet[bullet_count].active = false;
                            game_o.supportship[supportship_count].bullet[bullet_count].x_pos  = 2.0f;
                     ...
                     if (game_o.supportship[supportship_count].bullet[bullet_count].y_dir == 4)
                     {
                        game_o.supportship[supportship_count].bullet[bullet_count].y_pos -= game_o.supportship[supportship_count].bullet[bullet_count].y_speed*1.25f;
                        if (game_o.supportship[supportship_count].bullet[bullet_count].y_pos < (-1.0f-game_o.supportship[supportship_count].bullet[bullet_count].hight/2))
                        {
                            game_o.supportship[supportship_count].bullet[bullet_count].active = false;
                            game_o.supportship[supportship_count].bullet[bullet_count].x_pos  = 2.0f;
                     ...
                     if (game_o.supportship[supportship_count].bullet[bullet_count].y_dir == 1)
                     {
                        game_o.supportship[supportship_count].bullet[bullet_count].y_pos += game_o.supportship[supportship_count].bullet[bullet_count].y_speed*0.25;
                        if (game_o.supportship[supportship_count].bullet[bullet_count].y_pos > (1.0f+game_o.supportship[supportship_count].bullet[bullet_count].hight/2))
                        {
                     ...
                     if (game_o.supportship[supportship_count].bullet[bullet_count].y_dir == 3)
                     {
                        game_o.supportship[supportship_count].bullet[bullet_count].y_pos += game_o.supportship[supportship_count].bullet[bullet_count].y_speed*0.75f;
                        if (game_o.supportship[supportship_count].bullet[bullet_count].y_pos > (1.0f+game_o.supportship[supportship_count].bullet[bullet_count].hight/2))
                        {
                     ...
                     if (game_o.supportship[supportship_count].bullet[bullet_count].y_dir == 5)
                     {
                       game_o.supportship[supportship_count].bullet[bullet_count].y_pos += game_o.supportship[supportship_count].bullet[bullet_count].y_speed*1.25f;
                        if (game_o.supportship[supportship_count].bullet[bullet_count].y_pos > (1.0f+game_o.supportship[supportship_count].bullet[bullet_count].hight/2))
                        {
            ...
            {
               if ((game_o.npc[npc_count].active) and (game_o.supportship[supportship_count].bullet[bullet_count].active))// check player supportship bullets / npc collisions...
               {
                  if (game.physics.quadrangle_collision(game_o.npc[npc_count].x_pos,game_o.npc[npc_count].y_pos,game_o.npc[npc_count].width,game_o.npc[npc_count].hight,game_o.supportship[supportship_count].bullet[bullet_count].x_pos,game_o.supportship[supportship_count].bullet[bullet_count].y_pos,game_o.supportship[supportship_count].bullet[bullet_count].width,game_o.supportship[supportship_count].bullet[bullet_count].hight))
                  {
                     game_o.npc[npc_count].health -= game_o.projectile[game_o.supportship[supportship_count].bullet[bullet_count].warhead].damage;
                     if (game_o.npc[npc_count].health <= 0)
                     {
                        random_temp = random_int();
                        if (random_temp <= game_o.coin_spawn_rate) //spawn coin
               ...
               {
                    if ((game_o.npc[npc_count].bullet[npc_bullet_num].active) and (game_o.supportship[supportship_count].bullet[bullet_count].active))
                    {
                        if (game.physics.quadrangle_collision(game_o.npc[npc_count].bullet[npc_bullet_num].x_pos,game_o.npc[npc_count].bullet[npc_bullet_num].y_pos,game_o.npc[npc_count].bullet[npc_bullet_num].width,game_o.npc[npc_count].bullet[npc_bullet_num].hight,game_o.supportship[supportship_count].bullet[bullet_count].x_pos,game_o.supportship[supportship_count].bullet[bullet_count].y_pos,game_o.supportship[supportship_count].bullet[bullet_count].width,game_o.supportship[supportship_count].bullet[bullet_count].hight))
                        {
                            spawn_explosion(game_o.npc[npc_count].bullet[npc_bullet_num].x_pos,game_o.npc[npc_count].bullet[npc_bullet_num].y_pos,0.25f);
                            sound.explosion_001.play();
                            game_o.supportship[supportship_count].bullet[bullet_count].active = false;

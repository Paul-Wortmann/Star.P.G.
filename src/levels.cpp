...
int init_game_level(int level_no)
{
    ...
    game_o.background_scroll[0].scroll_rate  = 0.0050f;
    game_o.background_scroll[1].scroll_rate  = 0.0050f;
    game_o.background_scroll[2].scroll_rate  = 0.0020f;
    game_o.background_scroll[3].scroll_rate  = 0.0020f;

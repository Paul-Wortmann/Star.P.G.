...
{
    int texture_count = 0;
    texture.res_1024x768.load_image("data/textures/menu/1024x768.png",texture_count);texture_count++;
    texture.res_1024x768_highlighted.load_image("data/textures/menu/1024x768_highlighted.png",texture_count);texture_count++;
    texture.res_1280x1024.load_image("data/textures/menu/1280x1024.png",texture_count);texture_count++;
    texture.res_1280x1024_highlighted.load_image("data/textures/menu/1280x1024_highlighted.png",texture_count);texture_count++;
    texture.res_1366x768.load_image("data/textures/menu/1366x768.png",texture_count);texture_count++;
    texture.res_1366x768_highlighted.load_image("data/textures/menu/1366x768_highlighted.png",texture_count);texture_count++;
    texture.res_1440x900.load_image("data/textures/menu/1440x900.png",texture_count);texture_count++;
    texture.res_1440x900_highlighted.load_image("data/textures/menu/1440x900_highlighted.png",texture_count);texture_count++;
    texture.res_1680x1050.load_image("data/textures/menu/1680x1050.png",texture_count);texture_count++;
    texture.res_1680x1050_highlighted.load_image("data/textures/menu/1680x1050_highlighted.png",texture_count);texture_count++;
    texture.res_1920x1080.load_image("data/textures/menu/1920x1080.png",texture_count);texture_count++;
    texture.res_1920x1080_highlighted.load_image("data/textures/menu/1920x1080_highlighted.png",texture_count);texture_count++;
    texture.res_640x480.load_image("data/textures/menu/640x480.png",texture_count);texture_count++;
    texture.res_640x480_highlighted.load_image("data/textures/menu/640x480_highlighted.png",texture_count);texture_count++;
    texture.res_800x600.load_image("data/textures/menu/800x600.png",texture_count);texture_count++;
    texture.res_800x600_highlighted.load_image("data/textures/menu/800x600_highlighted.png",texture_count);texture_count++;
    ...
    texture.save_game_00.load_image("data/textures/menu/save_game_00.png",texture_count);texture_count++;
    texture.save_game_01.load_image("data/textures/menu/save_game_01.png",texture_count);texture_count++;
    texture.save_game_02.load_image("data/textures/menu/save_game_02.png",texture_count);texture_count++;
    texture.save_game_03.load_image("data/textures/menu/save_game_03.png",texture_count);texture_count++;
    texture.save_game_04.load_image("data/textures/menu/save_game_04.png",texture_count);texture_count++;
    texture.save_game_05.load_image("data/textures/menu/save_game_05.png",texture_count);texture_count++;
    texture.save_game_highlighted_00.load_image("data/textures/menu/save_game_highlighted_00.png",texture_count);texture_count++;
    texture.save_game_highlighted_01.load_image("data/textures/menu/save_game_highlighted_01.png",texture_count);texture_count++;
    texture.save_game_highlighted_02.load_image("data/textures/menu/save_game_highlighted_02.png",texture_count);texture_count++;
    texture.save_game_highlighted_03.load_image("data/textures/menu/save_game_highlighted_03.png",texture_count);texture_count++;
...
{
    if (texture_number ==   0) glBindTexture( GL_TEXTURE_2D, texture.res_1024x768.frame[0].data);
    if (texture_number ==   1) glBindTexture( GL_TEXTURE_2D, texture.res_1024x768_highlighted.frame[0].data);
    if (texture_number ==   2) glBindTexture( GL_TEXTURE_2D, texture.res_1280x1024.frame[0].data);
    if (texture_number ==   3) glBindTexture( GL_TEXTURE_2D, texture.res_1280x1024_highlighted.frame[0].data);
    if (texture_number ==   4) glBindTexture( GL_TEXTURE_2D, texture.res_1366x768.frame[0].data);
    if (texture_number ==   5) glBindTexture( GL_TEXTURE_2D, texture.res_1366x768_highlighted.frame[0].data);
    if (texture_number ==   6) glBindTexture( GL_TEXTURE_2D, texture.res_1440x900.frame[0].data);
    if (texture_number ==   7) glBindTexture( GL_TEXTURE_2D, texture.res_1440x900_highlighted.frame[0].data);
    if (texture_number ==   8) glBindTexture( GL_TEXTURE_2D, texture.res_1680x1050.frame[0].data);
    if (texture_number ==   9) glBindTexture( GL_TEXTURE_2D, texture.res_1680x1050_highlighted.frame[0].data);
    if (texture_number ==  10) glBindTexture( GL_TEXTURE_2D, texture.res_1920x1080.frame[0].data);
    if (texture_number ==  11) glBindTexture( GL_TEXTURE_2D, texture.res_1920x1080_highlighted.frame[0].data);
    if (texture_number ==  12) glBindTexture( GL_TEXTURE_2D, texture.res_640x480.frame[0].data);
    if (texture_number ==  13) glBindTexture( GL_TEXTURE_2D, texture.res_640x480_highlighted.frame[0].data);
    if (texture_number ==  14) glBindTexture( GL_TEXTURE_2D, texture.res_800x600.frame[0].data);
    if (texture_number ==  15) glBindTexture( GL_TEXTURE_2D, texture.res_800x600_highlighted.frame[0].data);
    if (texture_number ==  16) glBindTexture( GL_TEXTURE_2D, texture.bar_001.frame[0].data);
    if (texture_number ==  17) glBindTexture( GL_TEXTURE_2D, texture.bar_001_highlighted.frame[0].data);
    if (texture_number ==  18) glBindTexture( GL_TEXTURE_2D, texture.bar_002.frame[0].data);
    if (texture_number ==  19) glBindTexture( GL_TEXTURE_2D, texture.bar_002_highlighted.frame[0].data);
    if (texture_number ==  20) glBindTexture( GL_TEXTURE_2D, texture.customize_starship.frame[0].data);
    if (texture_number ==  21) glBindTexture( GL_TEXTURE_2D, texture.customize_starship_highlighted.frame[0].data);
    if (texture_number ==  22) glBindTexture( GL_TEXTURE_2D, texture.front_weapon.frame[0].data);
    if (texture_number ==  23) glBindTexture( GL_TEXTURE_2D, texture.front_weapon_highlighted.frame[0].data);
    if (texture_number ==  24) glBindTexture( GL_TEXTURE_2D, texture.fullscreen.frame[0].data);
    if (texture_number ==  25) glBindTexture( GL_TEXTURE_2D, texture.fullscreen_highlighted.frame[0].data);
    if (texture_number ==  26) glBindTexture( GL_TEXTURE_2D, texture.game_menu.frame[0].data);
    if (texture_number ==  27) glBindTexture( GL_TEXTURE_2D, texture.game_menu_highlighted.frame[0].data);
    if (texture_number ==  28) glBindTexture( GL_TEXTURE_2D, texture.load_game.frame[0].data);
    if (texture_number ==  29) glBindTexture( GL_TEXTURE_2D, texture.load_game_highlighted.frame[0].data);
    if (texture_number ==  30) glBindTexture( GL_TEXTURE_2D, texture.logo.frame[0].data);
    if (texture_number ==  31) glBindTexture( GL_TEXTURE_2D, texture.main_menu.frame[0].data);
    if (texture_number ==  32) glBindTexture( GL_TEXTURE_2D, texture.main_menu_highlighted.frame[0].data);
    if (texture_number ==  33) glBindTexture( GL_TEXTURE_2D, texture.music_volume.frame[0].data);
    if (texture_number ==  34) glBindTexture( GL_TEXTURE_2D, texture.music_volume_highlighted.frame[0].data);
    if (texture_number ==  35) glBindTexture( GL_TEXTURE_2D, texture.new_game.frame[0].data);
    if (texture_number ==  36) glBindTexture( GL_TEXTURE_2D, texture.new_game_highlighted.frame[0].data);
    if (texture_number ==  37) glBindTexture( GL_TEXTURE_2D, texture.off.frame[0].data);
    if (texture_number ==  38) glBindTexture( GL_TEXTURE_2D, texture.off_highlighted.frame[0].data);
    if (texture_number ==  39) glBindTexture( GL_TEXTURE_2D, texture.on.frame[0].data);
    if (texture_number ==  40) glBindTexture( GL_TEXTURE_2D, texture.on_highlighted.frame[0].data);
    if (texture_number ==  41) glBindTexture( GL_TEXTURE_2D, texture.options.frame[0].data);
    if (texture_number ==  42) glBindTexture( GL_TEXTURE_2D, texture.options_highlighted.frame[0].data);
    if (texture_number ==  43) glBindTexture( GL_TEXTURE_2D, texture.options_menu.frame[0].data);
    if (texture_number ==  44) glBindTexture( GL_TEXTURE_2D, texture.options_menu_highlighted.frame[0].data);
    if (texture_number ==  45) glBindTexture( GL_TEXTURE_2D, texture.quit_game.frame[0].data);
    if (texture_number ==  46) glBindTexture( GL_TEXTURE_2D, texture.quit_game_highlighted.frame[0].data);
    if (texture_number ==  47) glBindTexture( GL_TEXTURE_2D, texture.resolution.frame[0].data);
    if (texture_number ==  48) glBindTexture( GL_TEXTURE_2D, texture.resolution_highlighted.frame[0].data);
    if (texture_number ==  49) glBindTexture( GL_TEXTURE_2D, texture.resume_game.frame[0].data);
    if (texture_number ==  50) glBindTexture( GL_TEXTURE_2D, texture.resume_game_highlighted.frame[0].data);
    if (texture_number ==  51) glBindTexture( GL_TEXTURE_2D, texture.save_game.frame[0].data);
    if (texture_number ==  52) glBindTexture( GL_TEXTURE_2D, texture.save_game_highlighted.frame[0].data);
    if (texture_number ==  53) glBindTexture( GL_TEXTURE_2D, texture.shield.frame[0].data);
    if (texture_number ==  54) glBindTexture( GL_TEXTURE_2D, texture.shield_highlighted.frame[0].data);
    if (texture_number ==  55) glBindTexture( GL_TEXTURE_2D, texture.side_weapon.frame[0].data);
    if (texture_number ==  56) glBindTexture( GL_TEXTURE_2D, texture.side_weapon_highlighted.frame[0].data);
    if (texture_number ==  57) glBindTexture( GL_TEXTURE_2D, texture.sound_volume.frame[0].data);
    if (texture_number ==  58) glBindTexture( GL_TEXTURE_2D, texture.sound_volume_highlighted.frame[0].data);
    if (texture_number ==  59) glBindTexture( GL_TEXTURE_2D, texture.star_map.frame[0].data);
    if (texture_number ==  60) glBindTexture( GL_TEXTURE_2D, texture.star_map_highlighted.frame[0].data);
    if (texture_number ==  61) glBindTexture( GL_TEXTURE_2D, texture.thrusters.frame[0].data);
    if (texture_number ==  62) glBindTexture( GL_TEXTURE_2D, texture.thrusters_highlighted.frame[0].data);

    if (texture_number ==  63) glBindTexture( GL_TEXTURE_2D, texture.menu_background_000.frame[0].data);
    if (texture_number ==  64) glBindTexture( GL_TEXTURE_2D, texture.menu_background_001.frame[0].data);
    if (texture_number ==  65) glBindTexture( GL_TEXTURE_2D, texture.background_000.frame[0].data);
    if (texture_number ==  66) glBindTexture( GL_TEXTURE_2D, texture.background_001.frame[0].data);
    if (texture_number ==  67) glBindTexture( GL_TEXTURE_2D, texture.background_002.frame[0].data);
    if (texture_number ==  68) glBindTexture( GL_TEXTURE_2D, texture.background_003.frame[0].data);
    if (texture_number ==  69) glBindTexture( GL_TEXTURE_2D, texture.background_004.frame[0].data);
    if (texture_number ==  70) glBindTexture( GL_TEXTURE_2D, texture.background_005.frame[0].data);
    if (texture_number ==  71) glBindTexture( GL_TEXTURE_2D, texture.background_006.frame[0].data);
    if (texture_number ==  72) glBindTexture( GL_TEXTURE_2D, texture.background_007.frame[0].data);
    if (texture_number ==  73) glBindTexture( GL_TEXTURE_2D, texture.background_008.frame[0].data);
    if (texture_number ==  74) glBindTexture( GL_TEXTURE_2D, texture.background_009.frame[0].data);
    if (texture_number ==  75) glBindTexture( GL_TEXTURE_2D, texture.background_010.frame[0].data);
    if (texture_number ==  76) glBindTexture( GL_TEXTURE_2D, texture.background_011.frame[0].data);
    if (texture_number ==  77) glBindTexture( GL_TEXTURE_2D, texture.background_012.frame[0].data);
    if (texture_number ==  78) glBindTexture( GL_TEXTURE_2D, texture.background_013.frame[0].data);
    if (texture_number ==  79) glBindTexture( GL_TEXTURE_2D, texture.background_014.frame[0].data);
    if (texture_number ==  80) glBindTexture( GL_TEXTURE_2D, texture.background_015.frame[0].data);
    if (texture_number ==  81) glBindTexture( GL_TEXTURE_2D, texture.background_016.frame[0].data);
    if (texture_number ==  82) glBindTexture( GL_TEXTURE_2D, texture.background_017.frame[0].data);
    if (texture_number ==  83) glBindTexture( GL_TEXTURE_2D, texture.background_018.frame[0].data);
    if (texture_number ==  84) glBindTexture( GL_TEXTURE_2D, texture.background_019.frame[0].data);
    if (texture_number ==  85) glBindTexture( GL_TEXTURE_2D, texture.background_020.frame[0].data);
    if (texture_number ==  86) glBindTexture( GL_TEXTURE_2D, texture.background_021.frame[0].data);
    if (texture_number ==  87) glBindTexture( GL_TEXTURE_2D, texture.background_022.frame[0].data);
    if (texture_number ==  88) glBindTexture( GL_TEXTURE_2D, texture.background_023.frame[0].data);
    if (texture_number ==  89) glBindTexture( GL_TEXTURE_2D, texture.background_024.frame[0].data);
    if (texture_number ==  90) glBindTexture( GL_TEXTURE_2D, texture.background_025.frame[0].data);
    if (texture_number ==  91) glBindTexture( GL_TEXTURE_2D, texture.background_026.frame[0].data);
    if (texture_number ==  92) glBindTexture( GL_TEXTURE_2D, texture.background_027.frame[0].data);
    if (texture_number ==  93) glBindTexture( GL_TEXTURE_2D, texture.background_028.frame[0].data);
    if (texture_number ==  94) glBindTexture( GL_TEXTURE_2D, texture.background_029.frame[0].data);
    if (texture_number ==  95) glBindTexture( GL_TEXTURE_2D, texture.background_030.frame[0].data);
    if (texture_number ==  96) glBindTexture( GL_TEXTURE_2D, texture.background_031.frame[0].data);

    if (texture_number ==  97) glBindTexture( GL_TEXTURE_2D, texture.level_00.frame[0].data);
    if (texture_number ==  98) glBindTexture( GL_TEXTURE_2D, texture.level_01.frame[0].data);
    if (texture_number ==  99) glBindTexture( GL_TEXTURE_2D, texture.level_02.frame[0].data);
    if (texture_number == 100) glBindTexture( GL_TEXTURE_2D, texture.level_03.frame[0].data);
    if (texture_number == 101) glBindTexture( GL_TEXTURE_2D, texture.level_04.frame[0].data);
    if (texture_number == 102) glBindTexture( GL_TEXTURE_2D, texture.level_05.frame[0].data);
    if (texture_number == 103) glBindTexture( GL_TEXTURE_2D, texture.level_06.frame[0].data);
    if (texture_number == 104) glBindTexture( GL_TEXTURE_2D, texture.level_07.frame[0].data);
    if (texture_number == 105) glBindTexture( GL_TEXTURE_2D, texture.level_08.frame[0].data);
    if (texture_number == 106) glBindTexture( GL_TEXTURE_2D, texture.level_09.frame[0].data);
    if (texture_number == 107) glBindTexture( GL_TEXTURE_2D, texture.level_10.frame[0].data);
    if (texture_number == 108) glBindTexture( GL_TEXTURE_2D, texture.level_11.frame[0].data);
    if (texture_number == 109) glBindTexture( GL_TEXTURE_2D, texture.level_12.frame[0].data);
    if (texture_number == 110) glBindTexture( GL_TEXTURE_2D, texture.level_13.frame[0].data);
    if (texture_number == 111) glBindTexture( GL_TEXTURE_2D, texture.level_14.frame[0].data);
    if (texture_number == 112) glBindTexture( GL_TEXTURE_2D, texture.level_15.frame[0].data);
    if (texture_number == 113) glBindTexture( GL_TEXTURE_2D, texture.level_16.frame[0].data);
    if (texture_number == 114) glBindTexture( GL_TEXTURE_2D, texture.level_17.frame[0].data);
    if (texture_number == 115) glBindTexture( GL_TEXTURE_2D, texture.level_18.frame[0].data);
    if (texture_number == 116) glBindTexture( GL_TEXTURE_2D, texture.level_19.frame[0].data);
    if (texture_number == 117) glBindTexture( GL_TEXTURE_2D, texture.level_20.frame[0].data);
    if (texture_number == 118) glBindTexture( GL_TEXTURE_2D, texture.level_21.frame[0].data);
    if (texture_number == 119) glBindTexture( GL_TEXTURE_2D, texture.level_22.frame[0].data);
    if (texture_number == 120) glBindTexture( GL_TEXTURE_2D, texture.level_23.frame[0].data);
    if (texture_number == 121) glBindTexture( GL_TEXTURE_2D, texture.level_24.frame[0].data);

    if (texture_number == 122) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_00.frame[0].data);
    if (texture_number == 123) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_01.frame[0].data);
    if (texture_number == 124) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_02.frame[0].data);
    if (texture_number == 125) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_03.frame[0].data);
    if (texture_number == 126) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_04.frame[0].data);
    if (texture_number == 127) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_05.frame[0].data);
    if (texture_number == 128) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_06.frame[0].data);
    if (texture_number == 129) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_07.frame[0].data);
    if (texture_number == 130) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_08.frame[0].data);
    if (texture_number == 131) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_09.frame[0].data);
    if (texture_number == 132) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_10.frame[0].data);
    if (texture_number == 133) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_11.frame[0].data);
    if (texture_number == 134) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_12.frame[0].data);
    if (texture_number == 135) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_13.frame[0].data);
    if (texture_number == 136) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_14.frame[0].data);
    if (texture_number == 137) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_15.frame[0].data);
    if (texture_number == 138) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_16.frame[0].data);
    if (texture_number == 139) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_17.frame[0].data);
    if (texture_number == 140) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_18.frame[0].data);
    if (texture_number == 141) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_19.frame[0].data);
    if (texture_number == 142) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_20.frame[0].data);
    if (texture_number == 143) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_21.frame[0].data);
    if (texture_number == 144) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_22.frame[0].data);
    if (texture_number == 145) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_23.frame[0].data);
    if (texture_number == 146) glBindTexture( GL_TEXTURE_2D, texture.level_highlighted_24.frame[0].data);

    if (texture_number == 147) glBindTexture( GL_TEXTURE_2D, texture.level_preview_00.frame[0].data);
    if (texture_number == 148) glBindTexture( GL_TEXTURE_2D, texture.level_preview_01.frame[0].data);
    if (texture_number == 149) glBindTexture( GL_TEXTURE_2D, texture.level_preview_02.frame[0].data);
    if (texture_number == 150) glBindTexture( GL_TEXTURE_2D, texture.level_preview_03.frame[0].data);
    if (texture_number == 151) glBindTexture( GL_TEXTURE_2D, texture.level_preview_04.frame[0].data);
    if (texture_number == 152) glBindTexture( GL_TEXTURE_2D, texture.level_preview_05.frame[0].data);
    if (texture_number == 153) glBindTexture( GL_TEXTURE_2D, texture.level_preview_06.frame[0].data);
    if (texture_number == 154) glBindTexture( GL_TEXTURE_2D, texture.level_preview_07.frame[0].data);
    if (texture_number == 155) glBindTexture( GL_TEXTURE_2D, texture.level_preview_08.frame[0].data);
    if (texture_number == 156) glBindTexture( GL_TEXTURE_2D, texture.level_preview_09.frame[0].data);
    if (texture_number == 157) glBindTexture( GL_TEXTURE_2D, texture.level_preview_10.frame[0].data);
    if (texture_number == 158) glBindTexture( GL_TEXTURE_2D, texture.level_preview_11.frame[0].data);
    if (texture_number == 159) glBindTexture( GL_TEXTURE_2D, texture.level_preview_12.frame[0].data);
    if (texture_number == 160) glBindTexture( GL_TEXTURE_2D, texture.level_preview_13.frame[0].data);
    if (texture_number == 161) glBindTexture( GL_TEXTURE_2D, texture.level_preview_14.frame[0].data);
    if (texture_number == 162) glBindTexture( GL_TEXTURE_2D, texture.level_preview_15.frame[0].data);
    if (texture_number == 163) glBindTexture( GL_TEXTURE_2D, texture.level_preview_16.frame[0].data);
    if (texture_number == 164) glBindTexture( GL_TEXTURE_2D, texture.level_preview_17.frame[0].data);
    if (texture_number == 165) glBindTexture( GL_TEXTURE_2D, texture.level_preview_18.frame[0].data);
    if (texture_number == 166) glBindTexture( GL_TEXTURE_2D, texture.level_preview_19.frame[0].data);
    if (texture_number == 167) glBindTexture( GL_TEXTURE_2D, texture.level_preview_20.frame[0].data);
    if (texture_number == 168) glBindTexture( GL_TEXTURE_2D, texture.level_preview_21.frame[0].data);
    if (texture_number == 169) glBindTexture( GL_TEXTURE_2D, texture.level_preview_22.frame[0].data);
    if (texture_number == 170) glBindTexture( GL_TEXTURE_2D, texture.level_preview_23.frame[0].data);
    if (texture_number == 171) glBindTexture( GL_TEXTURE_2D, texture.level_preview_24.frame[0].data);
    if (texture_number == 172) glBindTexture( GL_TEXTURE_2D, texture.level_preview_locked.frame[0].data);

    if (texture_number == 173) glBindTexture( GL_TEXTURE_2D, texture.save_game_00.frame[0].data);
    if (texture_number == 174) glBindTexture( GL_TEXTURE_2D, texture.save_game_01.frame[0].data);
    if (texture_number == 175) glBindTexture( GL_TEXTURE_2D, texture.save_game_02.frame[0].data);
    if (texture_number == 176) glBindTexture( GL_TEXTURE_2D, texture.save_game_03.frame[0].data);
    if (texture_number == 177) glBindTexture( GL_TEXTURE_2D, texture.save_game_04.frame[0].data);
    if (texture_number == 178) glBindTexture( GL_TEXTURE_2D, texture.save_game_05.frame[0].data);
    if (texture_number == 179) glBindTexture( GL_TEXTURE_2D, texture.save_game_highlighted_00.frame[0].data);
    if (texture_number == 180) glBindTexture( GL_TEXTURE_2D, texture.save_game_highlighted_01.frame[0].data);
    if (texture_number == 181) glBindTexture( GL_TEXTURE_2D, texture.save_game_highlighted_02.frame[0].data);
    if (texture_number == 182) glBindTexture( GL_TEXTURE_2D, texture.save_game_highlighted_03.frame[0].data);
    if (texture_number == 183) glBindTexture( GL_TEXTURE_2D, texture.save_game_highlighted_04.frame[0].data);
    if (texture_number == 184) glBindTexture( GL_TEXTURE_2D, texture.save_game_highlighted_05.frame[0].data);

    if (texture_number == 185) glBindTexture( GL_TEXTURE_2D, texture.explosion_00.frame[0].data);
    if (texture_number == 186) glBindTexture( GL_TEXTURE_2D, texture.explosion_01.frame[0].data);
    if (texture_number == 187) glBindTexture( GL_TEXTURE_2D, texture.explosion_02.frame[0].data);
    if (texture_number == 188) glBindTexture( GL_TEXTURE_2D, texture.explosion_03.frame[0].data);
    if (texture_number == 189) glBindTexture( GL_TEXTURE_2D, texture.explosion_04.frame[0].data);
    if (texture_number == 190) glBindTexture( GL_TEXTURE_2D, texture.explosion_05.frame[0].data);
    if (texture_number == 191) glBindTexture( GL_TEXTURE_2D, texture.explosion_06.frame[0].data);
    if (texture_number == 192) glBindTexture( GL_TEXTURE_2D, texture.explosion_07.frame[0].data);
    if (texture_number == 193) glBindTexture( GL_TEXTURE_2D, texture.explosion_08.frame[0].data);
    if (texture_number == 194) glBindTexture( GL_TEXTURE_2D, texture.explosion_09.frame[0].data);
    if (texture_number == 195) glBindTexture( GL_TEXTURE_2D, texture.explosion_10.frame[0].data);
    if (texture_number == 196) glBindTexture( GL_TEXTURE_2D, texture.explosion_11.frame[0].data);
    if (texture_number == 197) glBindTexture( GL_TEXTURE_2D, texture.explosion_12.frame[0].data);
    if (texture_number == 198) glBindTexture( GL_TEXTURE_2D, texture.explosion_13.frame[0].data);
    if (texture_number == 199) glBindTexture( GL_TEXTURE_2D, texture.explosion_14.frame[0].data);
    if (texture_number == 200) glBindTexture( GL_TEXTURE_2D, texture.explosion_15.frame[0].data);
    if (texture_number == 201) glBindTexture( GL_TEXTURE_2D, texture.explosion_16.frame[0].data);
    if (texture_number == 202) glBindTexture( GL_TEXTURE_2D, texture.explosion_17.frame[0].data);
    if (texture_number == 203) glBindTexture( GL_TEXTURE_2D, texture.explosion_18.frame[0].data);
    if (texture_number == 204) glBindTexture( GL_TEXTURE_2D, texture.explosion_19.frame[0].data);
    if (texture_number == 205) glBindTexture( GL_TEXTURE_2D, texture.explosion_20.frame[0].data);
    if (texture_number == 206) glBindTexture( GL_TEXTURE_2D, texture.explosion_21.frame[0].data);
    if (texture_number == 207) glBindTexture( GL_TEXTURE_2D, texture.explosion_22.frame[0].data);
    if (texture_number == 208) glBindTexture( GL_TEXTURE_2D, texture.explosion_23.frame[0].data);
    if (texture_number == 209) glBindTexture( GL_TEXTURE_2D, texture.explosion_24.frame[0].data);

    if (texture_number == 210) glBindTexture( GL_TEXTURE_2D, texture.health_bar.frame[0].data);

    if (texture_number == 211) glBindTexture( GL_TEXTURE_2D, texture.weapon_000.frame[0].data);
    if (texture_number == 212) glBindTexture( GL_TEXTURE_2D, texture.weapon_001.frame[0].data);
    if (texture_number == 213) glBindTexture( GL_TEXTURE_2D, texture.weapon_002.frame[0].data);
    if (texture_number == 214) glBindTexture( GL_TEXTURE_2D, texture.weapon_003.frame[0].data);
    if (texture_number == 215) glBindTexture( GL_TEXTURE_2D, texture.weapon_004.frame[0].data);
    if (texture_number == 216) glBindTexture( GL_TEXTURE_2D, texture.weapon_005.frame[0].data);

    if (texture_number == 217) glBindTexture( GL_TEXTURE_2D, texture.shield_000.frame[0].data);
    if (texture_number == 218) glBindTexture( GL_TEXTURE_2D, texture.shield_001.frame[0].data);
    if (texture_number == 219) glBindTexture( GL_TEXTURE_2D, texture.shield_002.frame[0].data);
    if (texture_number == 220) glBindTexture( GL_TEXTURE_2D, texture.shield_003.frame[0].data);
    if (texture_number == 221) glBindTexture( GL_TEXTURE_2D, texture.shield_004.frame[0].data);

    if (texture_number == 222) glBindTexture( GL_TEXTURE_2D, texture.projectile_000.frame[0].data);
    if (texture_number == 223) glBindTexture( GL_TEXTURE_2D, texture.projectile_001.frame[0].data);
    if (texture_number == 224) glBindTexture( GL_TEXTURE_2D, texture.projectile_002.frame[0].data);
    if (texture_number == 225) glBindTexture( GL_TEXTURE_2D, texture.projectile_003.frame[0].data);
    if (texture_number == 226) glBindTexture( GL_TEXTURE_2D, texture.projectile_004.frame[0].data);
    if (texture_number == 227) glBindTexture( GL_TEXTURE_2D, texture.projectile_005.frame[0].data);
    if (texture_number == 228) glBindTexture( GL_TEXTURE_2D, texture.projectile_006.frame[0].data);
    if (texture_number == 229) glBindTexture( GL_TEXTURE_2D, texture.projectile_007.frame[0].data);
    if (texture_number == 230) glBindTexture( GL_TEXTURE_2D, texture.projectile_008.frame[0].data);
    if (texture_number == 231) glBindTexture( GL_TEXTURE_2D, texture.projectile_009.frame[0].data);
    if (texture_number == 232) glBindTexture( GL_TEXTURE_2D, texture.projectile_010.frame[0].data);
    if (texture_number == 233) glBindTexture( GL_TEXTURE_2D, texture.projectile_011.frame[0].data);
    if (texture_number == 234) glBindTexture( GL_TEXTURE_2D, texture.projectile_012.frame[0].data);
    if (texture_number == 235) glBindTexture( GL_TEXTURE_2D, texture.projectile_013.frame[0].data);
    if (texture_number == 236) glBindTexture( GL_TEXTURE_2D, texture.projectile_014.frame[0].data);
    if (texture_number == 237) glBindTexture( GL_TEXTURE_2D, texture.projectile_015.frame[0].data);
    if (texture_number == 238) glBindTexture( GL_TEXTURE_2D, texture.projectile_016.frame[0].data);
    if (texture_number == 239) glBindTexture( GL_TEXTURE_2D, texture.projectile_017.frame[0].data);
    if (texture_number == 240) glBindTexture( GL_TEXTURE_2D, texture.projectile_018.frame[0].data);
    if (texture_number == 241) glBindTexture( GL_TEXTURE_2D, texture.projectile_019.frame[0].data);
    if (texture_number == 242) glBindTexture( GL_TEXTURE_2D, texture.projectile_020.frame[0].data);
    if (texture_number == 243) glBindTexture( GL_TEXTURE_2D, texture.projectile_021.frame[0].data);
    if (texture_number == 244) glBindTexture( GL_TEXTURE_2D, texture.projectile_022.frame[0].data);
    if (texture_number == 245) glBindTexture( GL_TEXTURE_2D, texture.projectile_023.frame[0].data);
    if (texture_number == 246) glBindTexture( GL_TEXTURE_2D, texture.projectile_024.frame[0].data);
    if (texture_number == 247) glBindTexture( GL_TEXTURE_2D, texture.projectile_025.frame[0].data);
    if (texture_number == 248) glBindTexture( GL_TEXTURE_2D, texture.projectile_026.frame[0].data);
    if (texture_number == 249) glBindTexture( GL_TEXTURE_2D, texture.projectile_027.frame[0].data);
    if (texture_number == 250) glBindTexture( GL_TEXTURE_2D, texture.projectile_028.frame[0].data);
    if (texture_number == 251) glBindTexture( GL_TEXTURE_2D, texture.projectile_029.frame[0].data);
    if (texture_number == 252) glBindTexture( GL_TEXTURE_2D, texture.projectile_030.frame[0].data);

    if (texture_number == 253) glBindTexture( GL_TEXTURE_2D, texture.ship_000.frame[0].data);
    if (texture_number == 254) glBindTexture( GL_TEXTURE_2D, texture.ship_001.frame[0].data);
    if (texture_number == 255) glBindTexture( GL_TEXTURE_2D, texture.ship_002.frame[0].data);
    if (texture_number == 256) glBindTexture( GL_TEXTURE_2D, texture.ship_003.frame[0].data);
    if (texture_number == 257) glBindTexture( GL_TEXTURE_2D, texture.ship_004.frame[0].data);
    if (texture_number == 258) glBindTexture( GL_TEXTURE_2D, texture.ship_005.frame[0].data);
    if (texture_number == 259) glBindTexture( GL_TEXTURE_2D, texture.ship_006.frame[0].data);
    if (texture_number == 260) glBindTexture( GL_TEXTURE_2D, texture.ship_007.frame[0].data);
    if (texture_number == 261) glBindTexture( GL_TEXTURE_2D, texture.ship_008.frame[0].data);
    if (texture_number == 262) glBindTexture( GL_TEXTURE_2D, texture.ship_009.frame[0].data);
    if (texture_number == 263) glBindTexture( GL_TEXTURE_2D, texture.ship_010.frame[0].data);
    if (texture_number == 264) glBindTexture( GL_TEXTURE_2D, texture.ship_011.frame[0].data);
    if (texture_number == 265) glBindTexture( GL_TEXTURE_2D, texture.ship_012.frame[0].data);
    if (texture_number == 266) glBindTexture( GL_TEXTURE_2D, texture.ship_013.frame[0].data);
    if (texture_number == 267) glBindTexture( GL_TEXTURE_2D, texture.ship_014.frame[0].data);
    if (texture_number == 268) glBindTexture( GL_TEXTURE_2D, texture.ship_015.frame[0].data);
    if (texture_number == 269) glBindTexture( GL_TEXTURE_2D, texture.ship_016.frame[0].data);
    if (texture_number == 270) glBindTexture( GL_TEXTURE_2D, texture.ship_017.frame[0].data);
    if (texture_number == 271) glBindTexture( GL_TEXTURE_2D, texture.ship_018.frame[0].data);
    if (texture_number == 272) glBindTexture( GL_TEXTURE_2D, texture.ship_019.frame[0].data);
    if (texture_number == 273) glBindTexture( GL_TEXTURE_2D, texture.ship_020.frame[0].data);
    if (texture_number == 274) glBindTexture( GL_TEXTURE_2D, texture.ship_021.frame[0].data);
    if (texture_number == 275) glBindTexture( GL_TEXTURE_2D, texture.ship_022.frame[0].data);
    if (texture_number == 276) glBindTexture( GL_TEXTURE_2D, texture.ship_023.frame[0].data);
    if (texture_number == 277) glBindTexture( GL_TEXTURE_2D, texture.ship_024.frame[0].data);
    if (texture_number == 278) glBindTexture( GL_TEXTURE_2D, texture.ship_025.frame[0].data);

    if (texture_number == 279) glBindTexture( GL_TEXTURE_2D, texture.thruster_000.frame[0].data);
    if (texture_number == 280) glBindTexture( GL_TEXTURE_2D, texture.thruster_001.frame[0].data);
    if (texture_number == 281) glBindTexture( GL_TEXTURE_2D, texture.thruster_002.frame[0].data);

    if (texture_number == 282) glBindTexture( GL_TEXTURE_2D, texture.selection_box.frame[0].data);
    if (texture_number == 283) glBindTexture( GL_TEXTURE_2D, texture.none.frame[0].data);
    if (texture_number == 284) glBindTexture( GL_TEXTURE_2D, texture.locked.frame[0].data);
    if (texture_number == 285) glBindTexture( GL_TEXTURE_2D, texture.weapon_bar.frame[0].data);
    if (texture_number == 286) glBindTexture( GL_TEXTURE_2D, texture.shield_bar.frame[0].data);
    if (texture_number == 287) glBindTexture( GL_TEXTURE_2D, texture.thruster_bar.frame[0].data);
    if (texture_number == 288) glBindTexture( GL_TEXTURE_2D, texture.game_paused.frame[0].data);
    if (texture_number == 289) glBindTexture( GL_TEXTURE_2D, texture.game_saved.frame[0].data);
    if (texture_number == 290) glBindTexture( GL_TEXTURE_2D, texture.game_loaded.frame[0].data);

    if (texture_number == 291) glBindTexture( GL_TEXTURE_2D, texture.health_powerup.frame[0].data);
    if (texture_number == 292) glBindTexture( GL_TEXTURE_2D, texture.shield_lvlup_powerup.frame[0].data);
    if (texture_number == 293) glBindTexture( GL_TEXTURE_2D, texture.shield_new_powerup.frame[0].data);
    if (texture_number == 294) glBindTexture( GL_TEXTURE_2D, texture.thruster_lvlup_powerup.frame[0].data);
    if (texture_number == 295) glBindTexture( GL_TEXTURE_2D, texture.thruster_new_powerup.frame[0].data);
    if (texture_number == 296) glBindTexture( GL_TEXTURE_2D, texture.weapon_lvlup_powerup.frame[0].data);
    if (texture_number == 297) glBindTexture( GL_TEXTURE_2D, texture.weapon_new_powerup.frame[0].data);

    if (texture_number == 298) glBindTexture( GL_TEXTURE_2D, texture.achievements.frame[0].data);
    if (texture_number == 299) glBindTexture( GL_TEXTURE_2D, texture.achievements_highlighted.frame[0].data);
    if (texture_number == 300) glBindTexture( GL_TEXTURE_2D, texture.score.frame[0].data);
    if (texture_number == 301) glBindTexture( GL_TEXTURE_2D, texture.score_highlighted.frame[0].data);
    if (texture_number == 302) glBindTexture( GL_TEXTURE_2D, texture.kills.frame[0].data);
    if (texture_number == 303) glBindTexture( GL_TEXTURE_2D, texture.kills_highlighted.frame[0].data);
    if (texture_number == 304) glBindTexture( GL_TEXTURE_2D, texture.grey_star.frame[0].data);
    if (texture_number == 305) glBindTexture( GL_TEXTURE_2D, texture.bronze_star.frame[0].data);
    if (texture_number == 306) glBindTexture( GL_TEXTURE_2D, texture.silver_star.frame[0].data);
    if (texture_number == 307) glBindTexture( GL_TEXTURE_2D, texture.gold_star.frame[0].data);

    if (texture_number == 308) glBindTexture( GL_TEXTURE_2D, texture.kills_achievement.frame[0].data);
    if (texture_number == 309) glBindTexture( GL_TEXTURE_2D, texture.score_achievement.frame[0].data);
    if (texture_number == 310) glBindTexture( GL_TEXTURE_2D, texture.actinium_shields.frame[0].data);
    if (texture_number == 311) glBindTexture( GL_TEXTURE_2D, texture.blasters.frame[0].data);
    if (texture_number == 312) glBindTexture( GL_TEXTURE_2D, texture.burst_lasers.frame[0].data);
    if (texture_number == 313) glBindTexture( GL_TEXTURE_2D, texture.chain_guns.frame[0].data);
    if (texture_number == 314) glBindTexture( GL_TEXTURE_2D, texture.convolution_thrusters.frame[0].data);
    if (texture_number == 315) glBindTexture( GL_TEXTURE_2D, texture.health.frame[0].data);
    if (texture_number == 316) glBindTexture( GL_TEXTURE_2D, texture.ion_cannons.frame[0].data);
    if (texture_number == 317) glBindTexture( GL_TEXTURE_2D, texture.iridium_shileds.frame[0].data);
    if (texture_number == 318) glBindTexture( GL_TEXTURE_2D, texture.maelstrom_thrusters.frame[0].data);
    if (texture_number == 319) glBindTexture( GL_TEXTURE_2D, texture.plasma_rockets.frame[0].data);
    if (texture_number == 320) glBindTexture( GL_TEXTURE_2D, texture.rail_turrets.frame[0].data);
    if (texture_number == 321) glBindTexture( GL_TEXTURE_2D, texture.rubidium_shields.frame[0].data);
    if (texture_number == 322) glBindTexture( GL_TEXTURE_2D, texture.seismic_thrusters.frame[0].data);
    if (texture_number == 323) glBindTexture( GL_TEXTURE_2D, texture.shield_level_up.frame[0].data);
    if (texture_number == 324) glBindTexture( GL_TEXTURE_2D, texture.tantalum_shields.frame[0].data);
    if (texture_number == 325) glBindTexture( GL_TEXTURE_2D, texture.terbium_shields.frame[0].data);
    if (texture_number == 326) glBindTexture( GL_TEXTURE_2D, texture.thrusters_level_up.frame[0].data);
    if (texture_number == 327) glBindTexture( GL_TEXTURE_2D, texture.vortex_thrusters.frame[0].data);
    if (texture_number == 328) glBindTexture( GL_TEXTURE_2D, texture.weapon_level_up.frame[0].data);

    if (texture_number == 329) glBindTexture( GL_TEXTURE_2D, texture.game_over.frame[0].data);
    if (texture_number == 330) glBindTexture( GL_TEXTURE_2D, texture.logo_red.frame[0].data);
    if (texture_number == 331) glBindTexture( GL_TEXTURE_2D, texture.press_enter_for_the_main_menu.frame[0].data);
    if (texture_number == 332) glBindTexture( GL_TEXTURE_2D, texture.explosion_001.frame[0].data);
    if (texture_number == 333) glBindTexture( GL_TEXTURE_2D, texture.level_completed.frame[0].data);
    if (texture_number == 334) glBindTexture( GL_TEXTURE_2D, texture.enter_for_next_level.frame[0].data);
    if (texture_number == 335) glBindTexture( GL_TEXTURE_2D, texture.new_level_unlocked.frame[0].data);
    if (texture_number == 336) glBindTexture( GL_TEXTURE_2D, texture.thruster_003.frame[0].data);
    if (texture_number == 337) glBindTexture( GL_TEXTURE_2D, texture.coin_powerup.frame[0].data);
    if (texture_number == 338) glBindTexture( GL_TEXTURE_2D, texture.wexp_powerup.frame[0].data);
    ...
    if (texture_number == 349) glBindTexture( GL_TEXTURE_2D, texture.powerup_sideship_03.frame[0].data);
    if (texture_number == 350) glBindTexture( GL_TEXTURE_2D, texture.touchscreen_arrow.frame[0].data);
    if (texture_number == 351) glBindTexture( GL_TEXTURE_2D, texture.touchscreen_button.frame[0].data);

    if (texture_number == 352) glBindTexture( GL_TEXTURE_2D, texture.explosion_101.frame[0].data);
    if (texture_number == 353) glBindTexture( GL_TEXTURE_2D, texture.explosion_102.frame[0].data);
    if (texture_number == 354) glBindTexture( GL_TEXTURE_2D, texture.explosion_103.frame[0].data);
    if (texture_number == 355) glBindTexture( GL_TEXTURE_2D, texture.explosion_104.frame[0].data);
    if (texture_number == 356) glBindTexture( GL_TEXTURE_2D, texture.explosion_105.frame[0].data);
    if (texture_number == 357) glBindTexture( GL_TEXTURE_2D, texture.explosion_106.frame[0].data);
    if (texture_number == 358) glBindTexture( GL_TEXTURE_2D, texture.explosion_107.frame[0].data);
    if (texture_number == 359) glBindTexture( GL_TEXTURE_2D, texture.explosion_108.frame[0].data);
    if (texture_number == 360) glBindTexture( GL_TEXTURE_2D, texture.explosion_109.frame[0].data);
    if (texture_number == 361) glBindTexture( GL_TEXTURE_2D, texture.explosion_110.frame[0].data);
    if (texture_number == 362) glBindTexture( GL_TEXTURE_2D, texture.explosion_111.frame[0].data);
    if (texture_number == 363) glBindTexture( GL_TEXTURE_2D, texture.explosion_112.frame[0].data);

    if (texture_number == 364) glBindTexture( GL_TEXTURE_2D, texture.explosion_201.frame[0].data);
    if (texture_number == 365) glBindTexture( GL_TEXTURE_2D, texture.explosion_202.frame[0].data);
    if (texture_number == 366) glBindTexture( GL_TEXTURE_2D, texture.explosion_203.frame[0].data);
    if (texture_number == 367) glBindTexture( GL_TEXTURE_2D, texture.explosion_204.frame[0].data);
    if (texture_number == 368) glBindTexture( GL_TEXTURE_2D, texture.explosion_205.frame[0].data);
    if (texture_number == 369) glBindTexture( GL_TEXTURE_2D, texture.explosion_206.frame[0].data);
    if (texture_number == 370) glBindTexture( GL_TEXTURE_2D, texture.explosion_207.frame[0].data);
    if (texture_number == 371) glBindTexture( GL_TEXTURE_2D, texture.explosion_208.frame[0].data);
    if (texture_number == 372) glBindTexture( GL_TEXTURE_2D, texture.explosion_209.frame[0].data);
    if (texture_number == 373) glBindTexture( GL_TEXTURE_2D, texture.explosion_210.frame[0].data);
    if (texture_number == 374) glBindTexture( GL_TEXTURE_2D, texture.explosion_211.frame[0].data);
    if (texture_number == 375) glBindTexture( GL_TEXTURE_2D, texture.explosion_212.frame[0].data);
    if (texture_number == 376) glBindTexture( GL_TEXTURE_2D, texture.explosion_213.frame[0].data);
    if (texture_number == 377) glBindTexture( GL_TEXTURE_2D, texture.explosion_214.frame[0].data);
    if (texture_number == 378) glBindTexture( GL_TEXTURE_2D, texture.explosion_215.frame[0].data);
    if (texture_number == 379) glBindTexture( GL_TEXTURE_2D, texture.explosion_216.frame[0].data);
    if (texture_number == 380) glBindTexture( GL_TEXTURE_2D, texture.explosion_217.frame[0].data);
    if (texture_number == 381) glBindTexture( GL_TEXTURE_2D, texture.explosion_218.frame[0].data);
    if (texture_number == 382) glBindTexture( GL_TEXTURE_2D, texture.explosion_219.frame[0].data);
    if (texture_number == 383) glBindTexture( GL_TEXTURE_2D, texture.explosion_220.frame[0].data);
    if (texture_number == 384) glBindTexture( GL_TEXTURE_2D, texture.explosion_221.frame[0].data);
    if (texture_number == 385) glBindTexture( GL_TEXTURE_2D, texture.explosion_222.frame[0].data);
    if (texture_number == 386) glBindTexture( GL_TEXTURE_2D, texture.explosion_223.frame[0].data);
    if (texture_number == 387) glBindTexture( GL_TEXTURE_2D, texture.explosion_224.frame[0].data);
    if (texture_number == 388) glBindTexture( GL_TEXTURE_2D, texture.explosion_225.frame[0].data);
    if (texture_number == 389) glBindTexture( GL_TEXTURE_2D, texture.explosion_226.frame[0].data);
    if (texture_number == 390) glBindTexture( GL_TEXTURE_2D, texture.explosion_227.frame[0].data);
    if (texture_number == 391) glBindTexture( GL_TEXTURE_2D, texture.explosion_228.frame[0].data);
    if (texture_number == 392) glBindTexture( GL_TEXTURE_2D, texture.explosion_229.frame[0].data);
    if (texture_number == 393) glBindTexture( GL_TEXTURE_2D, texture.explosion_230.frame[0].data);

    if (texture_number == 394) glBindTexture( GL_TEXTURE_2D, texture.menu_background_002.frame[0].data);
    if (texture_number == 395) glBindTexture( GL_TEXTURE_2D, texture.menu_background_003.frame[0].data);
    if (texture_number == 396) glBindTexture( GL_TEXTURE_2D, texture.red_button.frame[0].data);
    if (texture_number == 397) glBindTexture( GL_TEXTURE_2D, texture.red_button_highlighted.frame[0].data);
    if (texture_number == 398) glBindTexture( GL_TEXTURE_2D, texture.green_button.frame[0].data);
    if (texture_number == 399) glBindTexture( GL_TEXTURE_2D, texture.green_button_highlighted.frame[0].data);
    if (texture_number == 400) glBindTexture( GL_TEXTURE_2D, texture.blue_button.frame[0].data);
    if (texture_number == 401) glBindTexture( GL_TEXTURE_2D, texture.blue_button_highlighted.frame[0].data);
    if (texture_number == 402) glBindTexture( GL_TEXTURE_2D, texture.arrow_button_normal.frame[0].data);
    if (texture_number == 403) glBindTexture( GL_TEXTURE_2D, texture.arrow_button_highlighted.frame[0].data);
    if (texture_number == 404) glBindTexture( GL_TEXTURE_2D, texture.arrow_button_disabled.frame[0].data);
    if (texture_number == 405) glBindTexture( GL_TEXTURE_2D, texture.slider_normal.frame[0].data);
    if (texture_number == 406) glBindTexture( GL_TEXTURE_2D, texture.slider_highlighted.frame[0].data);
    if (texture_number == 407) glBindTexture( GL_TEXTURE_2D, texture.resolution_icon.frame[0].data);
    if (texture_number == 408) glBindTexture( GL_TEXTURE_2D, texture.projectile_031.frame[0].data);
    return(true);
};

bool bind_texture(texture_class bind_me)
{
    glBindTexture( GL_TEXTURE_2D, bind_me.frame[0].data);
    return(true);
};

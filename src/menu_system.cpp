...
int init_menu   (void)
{
    ...
    star_map_menu.set_button_data  ( 3,"Main Menu        ");
    ...
    customize_starship_menu.set_button_data   ( 7,"Main Menu        ");
    ...
    achievements_menu.set_button_data     ( 4, "Main Menu         ");
    ...
    options_menu.set_button_data  ( 6,"Main Menu         ");
    ...
    game_over_menu.set_button_data  ( 1,"Main Menu         ");
    ...
    outro_menu.set_button_data  ( 1,"Main menu         ");
    ...
    pause_menu.set_button_data  ( 1,"Resume Game       ");

...
//   if (game.menu_level == 2) main_menu.draw();//star_map_menu
//   if (game.menu_level == 3) main_menu.draw();//customize_starship_menu
//   if (game.menu_level == 4) main_menu.draw();//achievements_menu
//   if (game.menu_level == 5) main_menu.draw();//load_menu
   if (game.menu_level == 6) save_menu.draw();//save_menu
//   if (game.menu_level == 7) main_menu.draw();//options_menu

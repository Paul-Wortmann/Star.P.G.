...
int init_menu   (void)
{
    ...
    customize_starship_menu.set_button_choice_data(1, 1,texture.none.ref_number,L"None              ", true,true);
    ...
    customize_starship_menu.set_button_choice_data(2, 1,texture.none.ref_number,L"None              ", true,true);
    ...
    customize_starship_menu.set_button_choice_data(3, 1,texture.none.ref_number,L"None              ", true,true);
    ...
    options_menu.set_button_choice_data(3, 1,texture.resolution_icon.ref_number,L"640 X 480         ", true, true);
    options_menu.set_button_choice_data(3, 2,texture.resolution_icon.ref_number,L"800 X 600         ", true, true);
    options_menu.set_button_choice_data(3, 3,texture.resolution_icon.ref_number,L"1024 X 768        ", true, true);
    options_menu.set_button_choice_data(3, 4,texture.resolution_icon.ref_number,L"1280 X 1024       ", true, true);
    options_menu.set_button_choice_data(3, 5,texture.resolution_icon.ref_number,L"1366 X 768        ", true, true);
    options_menu.set_button_choice_data(3, 6,texture.resolution_icon.ref_number,L"1440 X 900        ", true, true);
    options_menu.set_button_choice_data(3, 7,texture.resolution_icon.ref_number,L"1680 X 1050       ", true, true);
    options_menu.set_button_choice_data(3, 8,texture.resolution_icon.ref_number,L"1920 X 1080       ", true, true);

...
int init_menu   (void)
{
    ...
    star_map_menu.set_button_choice_data(1, 1,147,"Taranis", true);
    star_map_menu.set_button_choice_data(1, 2,148,"Teutates", true);
    star_map_menu.set_button_choice_data(1, 3,149,"Esus", true);
    star_map_menu.set_button_choice_data(1, 4,150,"Cantidious", true);
    star_map_menu.set_button_choice_data(1, 5,151,"Vulcan", true);
    star_map_menu.set_button_choice_data(1, 6,152,"Bacchus", true);
    star_map_menu.set_button_choice_data(1, 7,153,"Janus", true);
    star_map_menu.set_button_choice_data(1, 8,154,"Wrathorn", true);
    star_map_menu.set_button_choice_data(1, 9,155,"Tartarus", true);
    star_map_menu.set_button_choice_data(1,10,156,"Erebus", true);
    star_map_menu.set_button_choice_data(1,11,157,"Nyx", true);
    star_map_menu.set_button_choice_data(1,12,158,"Dediun", true);
    star_map_menu.set_button_choice_data(1,13,159,"Niflheim", true);
    star_map_menu.set_button_choice_data(1,14,160,"Muspelhiem", true);
    star_map_menu.set_button_choice_data(1,15,161,"Hel", true);
    star_map_menu.set_button_choice_data(1,16,162,"Paganite", true);
    star_map_menu.set_button_choice_data(1,17,163,"Pixiu", true);
    star_map_menu.set_button_choice_data(1,18,164,"Xiao", true);
    star_map_menu.set_button_choice_data(1,19,165,"Fuxi", true);
    star_map_menu.set_button_choice_data(1,20,166,"Haxorific", true);
    star_map_menu.set_button_choice_data(1,21,167,"Byakko", true);
    star_map_menu.set_button_choice_data(1,22,168,"Enenra", true);
    star_map_menu.set_button_choice_data(1,23,169,"Tengu", true);
    star_map_menu.set_button_choice_data(1,24,170,"Robonoid", true);
    star_map_menu.set_button_choice_data(1,25,171,"Oyabun", true);

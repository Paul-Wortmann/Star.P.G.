...
int init_menu   (void)
{
    ...
    next_level_menu.set_menu_title(L"Level Complete    ");
    ...
    next_level_menu.set_title_data(L"Level Complete    ");//needs to be called last due to size generated by number of buttons etc....
    return(0);
};
...
/*-----------------------------------------------------------------------------*/
   if (game.menu_level == 10) //Outro screen
   {
       ...
       {
            game.background.set_data ( 1, 1, 1, 0.0f, 0.0f, 0.0050f, 0.0050f, 63);
            game.background.set_data ( 2, 1, 1, 0.0f, 0.0f, 0.0050f, 0.0050f, 63);
